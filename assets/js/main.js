...
const fetchAllSuperHero = async(searchText) => {
    let url = `https://www.superheroapi.com/api.php/812629123100283/search/${searchText}`;
    try{
...
const showSuperheroDetails = (data) => {
    ...
    <li>
        <span>
            <i class = "fas fa-star"></i> Color de Cabello
        </span>
